...
class Otzivi extends Controller
{
	...
	public function index($name = '')
	{
		...
		$db_comments = new Database("comments", array(
		...
		require_once("app/functions/addComment.php"); 
		$addComment = new functions\addComment();
		...
		$this->view('comments/index', [
			...
			"formMessage"=>$addComment->index(), 
			"comments"=>$db_comments->getter(), 
			"footer"=>$footer->index() 
		]);
	}
}