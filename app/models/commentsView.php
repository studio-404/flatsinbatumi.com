		...
		if(count($this->data)) : 
			foreach ($this->data as $val) {
				...
				$out .= sprintf("<tr %s>
						...
						<td>%s</td>
						<td>
							<a href=\"javascript:void(0)\" onclick=\"updateCommentVisibility('%d','%s')\"><i class=\"material-icons tooltipped\" data-position=\"bottom\" data-delay=\"50\" data-tooltip=\"ხილვადობა\">%s</i></a>
