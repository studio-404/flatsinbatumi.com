...
class makeForm
{
	...
	public static function select($args)
	{
		...
		$out .= "<select id=\"".$args['id']."\" name=\"".$name."\" class=\"".$classname."\" ".$disabled.$multiple.">";
	...
	public static function inputText($args){
		...
		$classname = (isset($args["classname"])) ? $args["classname"] : "textfield"; 
		$out = "<div class=\"input-field\">";
		$out .= "<input type=\"text\" placeholder=\"".$args['placeholder']."\" autocomplete=\"off\" id=\"".$args['id']."\" class=\"".$classname."\" name=\"".$args['name']."\" value=\"".htmlentities($args['value'])."\"".$readyonly." />";
		$out .= "</div>";
