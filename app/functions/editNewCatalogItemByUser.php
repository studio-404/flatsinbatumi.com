...
class editNewCatalogItemByUser
{
	public $out;
	public function index()
	{
		...
		if(
			...
			//redirect::url(\Config::WEBSITE."ru/updateflat/?id=".request::index("GET","id"));
			redirect::url(\Config::WEBSITE."ru/profile?view=home");
		}
