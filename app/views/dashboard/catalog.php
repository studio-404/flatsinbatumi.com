					...
					<form action="?" method="get" id="moduleSearchForm" style="margin: 0 -10px 130px -10px;">
						<div class="col s8">
							<div class="input-field">
								<input type="text" placeholder="ძიება ID-ით" autocomplete="off" name="s" value="">
							</div>
						</div>
						<div class="col s2">
						...
						<div class="col s2">
							<a href="javascript:void(0)" onclick="location.href='http://bemyguest.ge/ru/dashboard/catalog/2'" class="waves-effect waves-light btn" style="margin: 25px 0 0 0; width: 100%">
								<i class="material-icons left">clear</i>წაშლა
							</a>
						</div>
					</form>
