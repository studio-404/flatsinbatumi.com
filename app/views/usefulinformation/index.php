...
require_once("app/functions/stringtoslide.php"); 
$l = new functions\l(); 
$stringtoslide = new functions\stringtoslide(); 
            ...
            <section class="list-group-item">
              ...
              <section class="row">
                <section class="col-sm-12" style="color: white">
                  <?=$stringtoslide->index($data['pageData']['text'])?>
                </section>
              </section>

              <section class="row">
                <section class="col-md-12">
                  <a href="/<?=$_SESSION["LANG"]?>/home" class="text-primary btn btn-success">Назад</a>
                </section>
              </section>
