var Config = {
	website:"http://flatsinbatumi.com/",
	ajax:"http://flatsinbatumi.com/ru/ajax/index", 
...
var changeVisibility = function(vis, id){
	...
	if(typeof vis === "undefined" || typeof id === "undefined"){
		$(".modal-message-box").html("E2");
	}else{
		$.ajax({
			method: "POST",
			url: Config.ajax + ajaxFile,
			data: { visibility: vis, idx: id }
		}).done(function( msg ) {
			var obj = $.parseJSON(msg);
			if(obj.Error.Code==1){
				$(".modal-message-box").html(obj.Error.Text);
...
var updateCommentVisibility = function(vis, id){
	var ajaxFile = "/updateCommentVisibility";
...
var add_catalog = function(catalogId, lang){
	...
	$.ajax({
		...
		if(obj.Error.Code==1){
			...
			$("#saleType").material_select();
			$("#cities").material_select();
			$("#rooms").material_select();
...
var searchVariants = function(id){
	var ajaxFile = "/searchVariants";
	var header = "<h4>განცხადება</h4><p class=\"modal-message-box\"></p>";
	var content = "<p>გთხოვთ დაიცადოთ...</p>";
	var footer = "<a href=\"javascript:void(0)\" class=\"waves-effect waves-green btn-flat modal-close\">დახურვა</a>";
...
var askRemoveVariants = function(id){
	var header = "<h4>შეტყობინება</h4><p class=\"modal-message-box\">გნებავთ წაშალოთ მონაცემი ?</p>";
	var footer = "<a href=\"javascript:void(0)\" onclick=\"removeVariants('"+id+"')\" class=\"waves-effect waves-green btn-flat\">დიახ</a>";
	footer += "<a href=\"javascript:void(0)\" class=\"waves-effect waves-green btn-flat modal-close\">დახურვა</a>";
...
var removeVariants = function(id){
	var ajaxFile = "/removeVariants";
	if(typeof id == "undefined"){
		$(".modal-message-box").html("E4");
	}else{
		$.ajax({
...
var openFileManager = function(photosBox, id){
	...
	$("#fileManager"+id).elfinder({
		...
		getFileCallback: function(url) {
            $("#"+id+" .card .card-image .activator").attr("src",Config.website+Config.mainLanguage+"/image/loadimage?f="+Config.website+"public/"+url.path+"&w=215&h=173&fromAdmin=true");
...
var tiny = function(selector){
	...
	tinymce.init({
	    ...
	    image_advtab: true, 
	    extended_valid_elements : "iframe[src|width|height|name|align],i[class|id|title]", 
	    relative_urls : 0, 
	    // verify_html : false,
...
var formCatalogAdd = function(catalogId, lang){
	...
	$("#pricebymonthtable .textfield").each(function(){
	...
	$("#additionalinfotable .additionalinfos").each(function(){
		var name = $(this).attr("name"); 
		var value = $(this).val(); 
		if(typeof name !== "undefined" && typeof value !== "undefined"){
	...
	$.ajax({
		...
		data: { 
			...
			type:type, 
			price:price, 
			serialPricebymonthtable:serialPricebymonthtable, 
			serialAdditionalinfotable:serialAdditionalinfotable, 
